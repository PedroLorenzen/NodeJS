...
<main>
    ...
    <div class="container">
        <div class="formButtons">
            <button
                on:click={() => switchForm("createJob")}
                class="toggle-button">Create Job</button
            >
            <button
                on:click={() => switchForm("editUser")}
                class="toggle-button">Update / Delete User</button
            >
        </div>
            ...
            >
                ...
                <div id="passwordDiv">
                    ...
                    <label for="newPassword" class="passwordRequirements"
                        >Password must be between 6 and 70 characters long,
                        include at least one uppercase letter, one special
                        character and not match the old password</label
                    >
                </div>
